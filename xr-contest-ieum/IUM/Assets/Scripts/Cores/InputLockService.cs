...
/// <summary>
/// What a holder blocks. Flags rather than a single bool because holders block different things:
/// 컷씬 takes movement, grabbing and PTT (F-003 3.4), while 튜토리얼 opens one flag at a time as
/// each control is taught.
///
/// 인게임 노장 대사는 여기에 없다. PTT 토큰으로 막았더니 이음이 호출이 사라져서
/// <c>InGameDialogue.AcquireHolds</c>의 우선순위 규칙으로 옮겼다.
/// </summary>
[Flags]
