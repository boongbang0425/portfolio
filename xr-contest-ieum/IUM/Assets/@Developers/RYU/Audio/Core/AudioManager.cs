...
namespace Core.Audio
{
    ...
    public sealed class AudioManager : Core.Foundation.Singleton<AudioManager>
    {
            ...
            bool sceneBound)
        {
            ...
            // minDistance·maxDistance는 미터 저작값이다. 재생 시점에 씬 배율을 곱한다 — 풀 채널은
            // 씬을 넘겨 재사용되므로 생성 시점 값만으로는 배율이 다른 씬에서 어긋난다.
            global::SceneWorldScale.Configure3D(source, minDistance, maxDistance);
